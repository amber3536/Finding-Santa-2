...
public class CameraMovementCastle : MonoBehaviour
{
    ...
    public CameraModeCastle mode = CameraModeCastle.GridFollow;
    ...
    void LateUpdate()
    {
        ...
        if (mode == CameraModeCastle.GridFollow)
        {
            transform.position = targetPosition;
        }
        else if (mode == CameraModeCastle.LockedPosition)
        {
    ...
    {
        lockedPosition = pos;
        mode = CameraModeCastle.LockedPosition;
    }

    public void ResumeFollow()
    {
        mode = CameraModeCastle.GridFollow;
    }
}
